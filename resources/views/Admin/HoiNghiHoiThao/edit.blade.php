...
@section('title', __('Sửa Hội nghị Hội thảo'))
@section('css')
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URl') }}{{ app()->getLocale() }}/admin/hoi-nghi-hoi-thao" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('Sửa Hội nghị Hội thảo') }}</h3>
            <form action="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/hoi-nghi-hoi-thao/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                {{ csrf_field() }}
