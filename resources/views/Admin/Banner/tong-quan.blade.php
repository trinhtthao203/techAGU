...
@section('title', __('Giới thiệu tổng quan'))
@section('css')
...
<div class="card-box">
    ...
    @endif
    <hr />
    <form action="{{ env('APP_URL').app()->getLocale() }}/admin/tong-quan/update" method="post" id="dinhkemform" enctype="multipart/form-data">
        {{ csrf_field() }}
