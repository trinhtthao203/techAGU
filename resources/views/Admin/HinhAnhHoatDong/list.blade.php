...
<div class="row">
    <div class="col-12 card-box">
        <h3 class="m-t-0"><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/hinh-anh-hoat-dong/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> {{ __('Thêm mới') }}</a> {{ __('Hình ảnh') }}</h3>
        @if($danhsach)
            ...
            <tbody>
                @foreach($danhsach as $k => $ds)
                    <tr>
                       ...
                       <td class="text-center">
                            <a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/hinh-anh-hoat-dong/delete/{{$ds['_id']}}" onclick="return confirm('Are you sure?')"><i class="fa fa-trash text-danger"></i></a>
                            <a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/hinh-anh-hoat-dong/edit/{{$ds['_id']}}"><i class="fas fa-pencil-alt"></i></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
