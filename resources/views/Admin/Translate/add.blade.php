...
@section('title', __('Thêm mới Translate'))
@section('body')
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/translate" class="btn btn-primary"><i class="fa fa-reply-all"></i></a> {{ __('Thêm mới Translate List') }}</h3>
            <form action="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/translate/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-body">
                    <hr />
                    @if($errors->any())
