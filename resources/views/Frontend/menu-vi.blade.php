    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse" id="navbar">
        ...
        <ul class="nav navbar-nav">
          ...
          <li><a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/category/tin-tuc" >{{ __('Tin tức') }}</a>
          ...
          <li class="dropdown"><a href="#"  data-toggle="dropdown" >{{ __('Liên kết') }} <i class="fa fa-angle-down" aria-hidden="true"></i></a>
            <ul class="dropdown-menu">
              ...
              <li><a class="fontla" href="https://www.facebook.com/agriyouthagu2015?locale=vi_VN">{{ __('Đoàn khoa Nông Nghiệp') }}</a></li>
            </ul>
          </li>
